...
-->
          ...
          <div class="clr"></div>
           <%
						...
						try 
						{
						String str1 = " select distinct(prime_genre_hash_code) from datasets ";
						Statement st1 = connection.createStatement();
						ResultSet rs1 = st1.executeQuery(str1);
						while(rs1.next())
						{
						    hsign = rs1.getString(1);
						   	String query="select * from datasets where prime_genre_hash_code = '"+hsign+"' "; 
...
<p align="center" class="style1">
       <span class="style1">Prime Genre Type Chain--->::</span> <%=s111%><br>
		<span class="style1">Prime Genre Type Hash Code --->::</span><%=hsign%></p>
	     </h2></pre>
			<div align="center">
			  <%
