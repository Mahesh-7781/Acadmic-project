      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style2">
			...
			<li><a href="U_View_All_Datasets.jsp">View All Uploaded Datasets</a></li>
			<li><a href="U_Find_Attack_Type.jsp">Find Attack Type</a></li>
			<li><a href="U_Find_Attacker_Type_By_Hashcode.jsp">Find Attacker Type By Hashcode</a></li>
