...
<head>
<title>A_View_Prime_Genre_Type_Results</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h2><span class="style1">Behavioral Model for Live Detection of Apps Based Attack <small></small></span></h2>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24">View Prime Genre Type Results !!!</h2>
...
<iframe width="650" height="550" src="Results1.jsp"></iframe>
