        ...
        <div class="article">
          ...
          <table width="608" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
						...
						String s1,s2,s3,s4,s5,s6,s7,s8,s71;
						int i=0;
						try 
						{
					   		...
					   		if ( rs.next() )
					   		{
								...
								s5=rs.getString(7);
								s6=rs.getString(11);
								s7=rs.getString(9); //Loc
								s71=rs.getString(10); //Loc
								s8=rs.getString(8);
            ...
            <tr>
              ...
              <td  width="69" align="left" valign="middle"><div align="left" class="style5 style62 style10 style40" style="margin-left:10px;"><span class="style5 style62 style10 style40" style="margin-left:10px;"><strong><strong>
              <%out.println(s5);%>
