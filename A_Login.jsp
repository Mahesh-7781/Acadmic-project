...
<div class="main">
  ...
  <div align="center">
    <table border="0" width="48%" height="138">
      <tr>
        <td width="57%" height="25" bgcolor="#FF0000"><div align="left"><font color="#000000"><b><font size="5" face="Courier New, Courier, monospace">Admin Name:</font></b></font></div></td>
        <td width="43%" height="25">
  <input type="text"  name="adminid" size="15"></td>
      </tr>
      <tr>
        <td width="57%" height="25" bgcolor="#FF0000"><div align="left"><font color="#000000"><b><font size="5" face="Courier New, Courier, monospace">Password:</font></b></font></div></td>
        <td width="43%" height="25">
