...
else
{
            ...
            <p align="center">
              <%
					  ...
					  String acc="Normal";
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,location,status,acctype,image,poll) values(?,?,?,?,?,?,?,?,?,?,?,?)");
